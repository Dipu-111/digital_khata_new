...
class _AddExpenseScreenState extends ConsumerState<AddExpenseScreen> {
  ...
  final List<String> _categories = [
    ...
    'Bills', 'Rent', 'Health', 'Education', 'Travel', 'Subscription', 'Other'
  ];
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              // Amount
              const Text('Amount *', style: TextStyle(fontSize: 13, color: Color(0xFF6B7280))),
              ...
              // Category
              const Text('Category *', style: TextStyle(fontSize: 13, color: Color(0xFF6B7280))),
              const SizedBox(height: 6),
              Container(
                  ...
                  child: DropdownButton<String>(
                    ...
                    items: _categories.map((category) {
                      return DropdownMenuItem(
                        value: category,
                        child: Text(category, style: TextStyle(color: isDarkMode ? Colors.white : const Color(0xFF1D293D))),
                      );
                    }).toList(),
                    onChanged: (value) {
                      setState(() {
              ...
              // Date
              const Text('Date *', style: TextStyle(fontSize: 13, color: Color(0xFF6B7280))),
              const SizedBox(height: 6),
              GestureDetector(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(color: isDarkMode ? Colors.white : const Color(0xFF1D293D)),
                      ),
              ...
              // Payment Method
              const Text('Payment Method', style: TextStyle(fontSize: 13, color: Color(0xFF6B7280))),
              const SizedBox(height: 6),
              Row(
              ...
              // Description
              const Text('Description', style: TextStyle(fontSize: 13, color: Color(0xFF6B7280))),
              const SizedBox(height: 6),
              TextFormField(
